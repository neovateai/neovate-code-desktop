...
export const CONTENT_PANEL_MIN_SIZE = 300;
export const PRIMARY_SIDEBAR_MIN_SIZE = 240;
export const PRIMARY_SIDEBAR_DEFAULT_SIZE = 300;
export const SECONDARY_SIDEBAR_MIN_SIZE = 240;
export const SECONDARY_SIDEBAR_MAX_SIZE = 400;
export const DEFAULT_PANEL_EXPAND_SIZE = 20;
